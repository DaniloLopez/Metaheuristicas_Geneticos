...
public class Archivo {
    ...
    public void abrirArchivo(String nombre, boolean escritura, boolean sobreescribir){     
        String ubicacion = obtenerRuta() + nombre;
        try {
            if (escritura)
            {                
    ...
    {
        String ubicacion = Archivo.obtenerRuta() + nombre;
        abrirArchivo(ubicacion,false, false);
        int lineas = 0;
        while (puedeLeer()){
                leerArchivo();
                lineas++;
    ...
    public static String obtenerRuta() {
            ...
            try {                
                ...
                ruta = miDir.getCanonicalPath()+sep + "Archivos" + sep;                
            } catch (Exception e) {
                System.out.println("Error al leer el archivo. clase Archivo, metodo obtenerRuta");
            }
            return ruta;
    }
